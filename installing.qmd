...
```cmd
<Name of folder that you put in 1st step>\Scripts\activate.bat
```

  * Windows (Powershell): 
```powershell
<Name of folder that you put in 1st step>\Scripts\Activate.ps1
```

  * macOS/Linux: 
```bash
source <Name of folder that you put in 1st step>/bin/activate
```
